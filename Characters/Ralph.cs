namespace Barkeep
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ProgressBar_Main = new Barkeep.TextProgressBar();
            this.ProgressBar_Detail = new Barkeep.TextProgressBar();
            ...
            this.ProgressBar_Main.VisualMode = Barkeep.ProgressBarDisplayMode.CurrProgress;
            // 
            // ProgressBar_Detail
            // 
            ...
            this.ProgressBar_Detail.VisualMode = Barkeep.ProgressBarDisplayMode.CurrProgress;
            // 
            // MainForm
            // 
    ...
    {
        public static double Reduce(string expression)
        {
            ...
            foreach (var token in expression.Split(' '))
            {
                ...
                else if (Array.IndexOf(operators, token[0]) >= 0)
                {
                    if (stack.Count < 2)
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            double result = ExpressionEvaluator.Reduce("5 + 2 * 3 - 4 / 2");
